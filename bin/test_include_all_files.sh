...
find lib -type f \( -iname "*.dart" ! -iname "*.g.dart" ! -iname "*.*.dart" ! -iname "l10n.dart" ! -iname "messages_*.dart" ! -iname "generated_plugin_registrant.dart" \) | cut -c4- | awk -v package="$1" '{printf "import '\''package:%s%s'\'';\n", package, $1}' >> $file
printf "\nvoid main(){}" >> $file
